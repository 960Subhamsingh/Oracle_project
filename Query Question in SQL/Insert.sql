--I have search how  many jobs available in each department
...
select initcap(dname) as department , count(*)  as amount  from emp, dept where  dept.deptno = emp.deptno  group by initcap(dname);
